...
const Hero = () => {
  ...
  const bgImages = ['/bg1.jpeg', '/bg.jpeg', '/bg2.jpeg' , '/bg3.jpeg'];
      ...
      <div className={`${styles.paddingX} absolute inset-0 top-[120px] max-w-7xl mx-auto flex flex-row items-start gap-5`}>
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>
            Hi, I'm <span className='text-[#915eff]'> Rabi</span>
          </h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            A software architect and enthusiastic developer
            <br className='sm:block hidden' /> deeply passionate about emerging technologies.
          </p>
        </div>
      </div>
      <div className='inset-0 flex justify-center items-center'>
        <img src={bgImages[bgIndex]} alt='hero' className='h-[100%] w-[100%]' />
      </div>
